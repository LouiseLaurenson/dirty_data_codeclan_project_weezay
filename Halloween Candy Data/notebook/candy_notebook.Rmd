...
* **Column names:** The Raw data had alot of isues with columns which had nothing to do with candy, this meant that having to filter out any columns that I found irrelevant to the task. *'e.g "Which day do you prefer, Friday or Sunday?"'* 
I also had to standardize alot of columns over the three data frames. *'e.g your_gender = gender'*
             
* **Age:** The age column in 2015 was as a character string with inputs that needed to cleaned, I made it as an integer column and rounded and .something ages to the nearest whole number, anything that was text input that didnt make sense was changed to NA.
